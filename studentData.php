                ...
                <div class="tab-inn">
                    <div class="table-responsive table-desi">
                        <table class="table table-hover">
                            ...
                            <tbody>
                            <?php $allPosts = $select->selectData('student'); ?>
                                <?php foreach ($allPosts as $allItem) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#"><span class="list-enq-name"><?php echo $allItem['email']; ?></span></a>
                                        </td>
                                        <td>
                                            <a href="#"><span class="list-enq-name"><?php echo $helper->humanTime(($allItem['create_at'])); ?></span></a>
                                        </td>
                                        <td>
                                            <a href="add_new_student.php" style="border-radius: 50%;"><i class="fas fa-plus-circle"></i></a>
                                        </td>
                                        <td>
