                ...
                <div class="box-inn-sp admin-form">
                    <div class="sb2-2-add-blog sb2-2-1">
                        ...
                        <ul class="nav nav-tabs tab-list">
                            <li class="active"><a data-toggle="tab" href="#home" aria-expanded="true"><i class="fa fa-info" aria-hidden="true"></i> <span>Admin</span></a>
                            </li>
                            ...
                            <li class=""><a data-toggle="tab" href="#menu2" aria-expanded="false">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="home" class="tab-pane fade active in">
                                <div class="box-inn-sp">
                                    ...
                                    <div class="alert alert-info notification" id="admin_notification" role="alert" style="margin-top: 5px;">
                                        
                                    </div>
                                    <div class="bor">
                                        <form id="new_admin_form"  method="POST">
                                            <div class="row">
                                                <div class="input-field col   s6">
                                                    <input id="admin_name" name="admin_name" type="text" class="validate">
                                                    <label for="list-title" class="">Name</label>
                                                </div>
                                                <div class="input-field col   s6">
                                                    <input id="admin_last_name" name="admin_last_name" type="text" class="validate">
                                                    <label for="list-name">Last Name</label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="input-field col  s12">
                                                    <input id="admin_email" name="admin_email" type="text" class="validate">
                                                    <label for="list-title" class="">E-mail</label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    <input id="admin_password" name="admin_password" type="password" class="validate">
                                                    <label for="list-title" class="">Password</label>
                                                </div>
                                                <div class="input-field col s6">
                                                    <input id="admin_confirmpassword" name="admin_confirmpassword" type="password" class="validate">
                                                    <label for="list-name">Confirm Password</label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <i class="waves-effect waves-light btn-large waves-input-wrapper" >
                                                        <input type="submit" name="make_admin_btn" id="make_admin_btn" class="waves-button-input" value="Submit">
                                                    </i>
                                                </div>
                                            </div>
                                        </form>
