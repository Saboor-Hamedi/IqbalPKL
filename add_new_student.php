            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-3 col-xs-6">
                    ...
                    <a class='waves-effect dropdown-button top-user-pro' href='#' data-activates='top-menu'>
                        <img src="images/user/6.png" alt="" />My Account <i class="fa fa-angle-down" aria-hidden="true"></i>
                    </a>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box-inn-sp admin-form">
                                    ...
                                    <div class="alert alert-info notification" id="student_message" role="alert">
                                        ...
                                        <form id="student_insert_form" method="POST">
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    <input type="text" id="student_first_name" name="student_first_name" class="validate" autocomplete="off">
                                                    <label class="">First name</label>
                                                </div>
                                                <div class="input-field col s6">
                                                    <input type="text" id="student_last_name" name="student_last_name" class="validate" autocomplete="off">
                                                    <label class="">Last name</label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <input type="text" id="student_email" name="student_email" class="validate" autocomplete="off">
                                                    <label class="">E-mail</label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    <input type="password" id="student_password" name="student_password" value="" class="validate" autocomplete="off">
                                                    <label class="">Password</label>
                                                </div>
                                                <div class="input-field col s6">
                                                    <input type="password" id="student_confirmpassword" name="student_confirmpassword" value="" class="validate" autocomplete="off">
                                            ...
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <i class="waves-effect waves-light btn-large waves-input-wrapper">
                                                        <input type="submit" id="student_insert_btn" name="student_insert_btn" value="Insert" class="waves-button-input">
                                                    </i>
                                                </div>
                                            </div>
                                        </form>
